...
p1 = Post.create(user: matt, topic: Topic.find_by(name: 'Sports'), neighborhood: Neighborhood.all[rand(Neighborhood.all.length)], description: 'this is a post about sports fhwkd gskrfns gth jwpg thskefos djtis tgkeps j jshed igjet jai thwt tdyw', date: Date.today, time_of_day: 'Evening')
