...
e3 = Event.create(post: p4, user: matt, description: "Let's get a snack and talk about what meals are good for which moods.", location: "This cafe at this location", date: Date.new(2019, 11, 4), time_hour: 5, time_minute: 0, time_am_pm: 'pm')
e4 = Event.create(post: p5, user: matt, description: "Let's get a snack and talk about what meals are good for which moods.", location: "This cafe at this location", date: Date.new(2019, 11, 3), time_hour: 5, time_minute: 0, time_am_pm: 'pm')
e5 = Event.create(post: p7, user: avi, description: "Let's get a snack and talk about what meals are good for which moods.", location: "This cafe at this location", date: Date.new(2019, 11, 4), time_hour: 5, time_minute: 0, time_am_pm: 'pm')
e6 = Event.create(post: p8, user: kim, description: "Let's get a snack and talk about what meals are good for which moods.", location: "This cafe at this location", date: Date.new(2019, 11, 4), time_hour: 5, time_minute: 0, time_am_pm: 'pm')
